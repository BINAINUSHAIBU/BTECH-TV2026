...
window.BTECH_CONFIG = Object.freeze({
  ...
  feeds: {
    ...
    category: (code) =>
      `https://iptv-org.github.io/iptv/categories/${code}.m3u`,
  ...
  packages: {
    premium: "packages/index_premium-package.html",
    ...
    superPremiumPlus: "packages/super-premium-compact-plus/index.html",
  },
});
